...
def download_cfx_vehicle_images():
    # URL của trang phương tiện trên Cfx.re Docs
    url = "https://docs.fivem.net/docs/game-references/vehicle-models/"
    base_url = "https://docs.fivem.net"
    save_dir = "cfx_vehicle_images"
    ...
    print("Đang truy cập trang web Cfx.re Docs (Vehicle models)...")
    try:
    ...
    # Docusaurus thường dùng thẻ <article> để chứa nội dung bài viết
    ...
    print(f"Tìm thấy {len(images)} ảnh xe. Bắt đầu tải...\n")
    ...
    print(f"\n✅ Hoàn tất! Đã tải thành công {count} ảnh xe vào thư mục '{save_dir}'.")

if __name__ == "__main__":
    download_cfx_vehicle_images()